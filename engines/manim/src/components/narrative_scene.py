"""engines/manim/src/components/narrative_scene.py
NarrativeScene — Template-driven stage orchestration for ManimCE.
...
class NarrativeScene(ZoneScene):
    ...
    template from ``engines/manim/src/templates/narratives/``.
    """

    NARRATIVE_PROFILE: str = "definition_reveal"

    # Animation primitives — ManimCE uses Create instead of ShowCreation.
    CREATION_ANIM = Create
    FADEIN_ANIM = FadeIn
    WRITE_ANIM = Write
