...
function renderSceneList() {
  ...
  if (!state.scenes.length) {
    el.innerHTML = '<div style="padding:20px;color:#484f858">No scenes found in .agent/tmp/</div>';
    return;
  }
  ...
  document.getElementById('sceneCount').textContent = state.scenes.length + ' scenes';
